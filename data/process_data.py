...
def load_data(messages_filepath, categories_filepath):
    ''' Loading messages and catagories and merging them into a panda dataframe.'''
...
def clean_data(df):
    '''Cleaning data, splitting categories and dropping duplicates.'''
    # spliting categories by ;
